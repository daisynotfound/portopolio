      ...
      <div className='w-full mx-auto container grid grid-cols-1 md:grid-cols-2 md:px-10 xl:px-20 py-10 md:gap-32'>
        ...
        <div className='flex flex-col gap-10 items-start justify-start  p-5 font-ProductSans text-fontColor'>
          <div className='flex flex-col gap-5'>
            ...
            <p className='text-xl md:text-xl lg:text-3xl font-semibold'>(Website Development)</p>
            <div>
              <p
                className='text-lg  lg:text-3xl text-[#6B7385]'>
                  Halo ini adalah personal portfolio saya. saya bersekolah di smkn 21 jakarta dan bercita cita menjadi seorang web developer</p>
            </div>
            ...
            <div className='flex flex-col gap-5'>
              ...
              <div className='flex flex-row px-2 gap-5'>
                ...
                {/* Instagram Icon */}
                <div
                  onClick={() => window.open('https://www.instagram.com/fandh._')}
      ...
      <div className='flex items-center justify-center font-ProductSans py-2'>
        <p>
          <span
            ...
            Made by </span>&#128512; <span className='font-bold'>Fajar Andhika</span>
        </p>
      </div>
    </div>
  )
